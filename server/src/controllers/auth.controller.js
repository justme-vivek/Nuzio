...
import { signToken, setAuthCookie, clearAuthCookie } from '../middleware/auth.middleware.js';
...
export const googleAuth = asyncHandler(async (req, res) => {
  ...
  if (!flags.googleConfigured()) {
    throw new ApiError(503, 'GOOGLE_CLIENT_ID is not configured on the server (server/.env)');
  }
